...
namespace PodawanieLicznikowTesty
{
    public class MediaTEST
    {
        ...
        public void TestThatAquaIsStillDividedByRate()
        {
            ...
            TestowyUzytkownik.GetMediaWater(testAquaONE);
            float testAquaTWO = TestowyUzytkownik.waterBill;
        ...
        public void TestThatGasIsStillDividedByRate()
        {
            ...
            float testGasTWO = TestowyUzytkownik.gasBill;
        ...
        public void TestThatElecticityIsStillDividedByRate()
        {
            ...
            TestowyUzytkownik.GetMediaElectricity(testElectricityONE);
            float testElectricityTWO = TestowyUzytkownik.electricityBill;
